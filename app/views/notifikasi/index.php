<div class="container">
    <h2 class="h4 fw-bold text-dark mb-4 border-bottom pb-2">Log Riwayat Aktivitas</h2>
...
<style>
    ...
    .text-dark {
        color: var(--bs-dark) !important; /* Ensure text is dark on light backgrounds */
    }

    /* Custom Gradient Backgrounds for Log Entries */
    .bg-gradient-success-light {
        background: linear-gradient(90deg, #d4edda, #e2ffe7); /* Soft green gradient */
    }
    .bg-gradient-warning-light {
        background: linear-gradient(90deg, #fff3cd, #fff8e2); /* Soft yellow gradient */
    }
    .bg-gradient-danger-light {
        background: linear-gradient(90deg, #f8d7da, #ffe7e9); /* Soft red gradient */
    }
    .bg-gradient-info-light {
        background: linear-gradient(90deg, #d1ecf1, #e0f6f9); /* Soft blue gradient */
    }
    ...
    /* Log Entry Styling */
    .p-3.rounded-3 {
        padding: 1.25rem !important; /* Slightly more padding */
        border-radius: 0.75rem !important; /* Softer rounded corners */
        transition: transform 0.2s ease, box-shadow 0.2s ease;
    }

    .p-3.rounded-3:hover {
        transform: translateY(-3px); /* Subtle lift on hover */
        box-shadow: 0 0.5rem 1rem rgba(0, 0, 0, 0.1) !important; /* More pronounced shadow on hover */
    }
    ...
    .animate__animated.animate__fadeInUp.animate__faster {
        animation-duration: 0.3s; /* Faster animation for individual items */
    }
</style>
